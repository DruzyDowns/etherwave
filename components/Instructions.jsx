    ...
    return (
      <div>
        ...
        <h3 className="pt-16 pb-2 text-2xl font-bold uppercase tracking-widest">add etherwave.js</h3>
          ...
          <p className="mb-4">Use this tool to add your <span className="font-bold">receiving</span> wallet address to the <span className="font-bold bg-gray-200 px-1 rounded-sm">data-destinationWallet</span> attribute of the script tag. Double, triple, quadruple check that this is the wallet address you want people to send ETH to. If you put the wrong address in here you won't receive anything! </p> 
          ...
          <p className="mb-16">I hope you can use this tool to get compensated for your amazing work. You deserve it, and I know you're gonna make it!</p>
      </div>
    );
  }
}
