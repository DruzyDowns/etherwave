...
yarn: yarn add web3`}
        ...
        <h3 className="pt-16 pb-2 text-2xl font-bold uppercase tracking-widest">add etherwave.js</h3>
          ...
          <p className="mb-4">If you like this project, find success with your donations, or just want to support my work, you can do so with my Etherwave widget right here on this page (whoah this is meta).</p>
