  ...
  render() {
    ...
    return (
      <div>
        ...
        <label>I am a freelance developer &amp; designer, on a mission to make it easier for creative types to use web3.0 technology. If you like this project, a small donation will help me continue this work!</label><input defaultValue="0.01" /><span>ETH</span><button>Tip</button>
      </form>
      </div>
    );
  }
